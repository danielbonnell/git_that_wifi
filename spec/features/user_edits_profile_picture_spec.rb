...
feature "user edits profile picture", %{
  ...
  -[ ] I see an error if the file I supplied is not a valid image format.
  ...
  scenario "visit your account detail and edit" do
    ...
    attach_file("user[avatar]", File.join(
    ...
    expect(page).to have_selector(
      "img[alt=\"/uploads/user/avatar/#{user.id}/cheezburger_410_6.jpg\"]"
    )
  end
